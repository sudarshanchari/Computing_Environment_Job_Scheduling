...
- Below I provide an example of how it can be used, for say, performing adapter trimming on multile fastq files. While this example is for slurm/ sbatch, it works just as well with a pbs/ qsub scheduler and any other ngs tools.
